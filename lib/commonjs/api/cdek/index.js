...
exports.Cdek = void 0;
var _eventemitter = require("./core/eventemitter.js");
var _restclient = require("./core/restclient.js");
class Cdek extends _eventemitter.EventEmitter {
  constructor(options) {
    super();
    this.rest = new _restclient.RestClient(options);
  }
  getRegions(params) {
